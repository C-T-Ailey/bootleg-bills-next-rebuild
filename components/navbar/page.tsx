...
export default function page() {
  ...
  return (
    <>
    <div className='w-screen absolute flex flex-col lg:flex-row justify-center items-between lg:justify-between lg:items-center lg:h-20 bg-bill-cyan shadow-md z-50'>
